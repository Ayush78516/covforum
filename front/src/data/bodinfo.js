import sandipImg from "/assets/Sandip_Kumar_Deb.avif";
import praveenGuptaImg from "/assets/Praveen Gupta.avif";
import psImg from "/assets/PS.avif";
import sgImg from "/assets/SG.avif";
import rahulImg from "/assets/Rahul Sharma.avif";
import hariomImg from "/assets/Hariom Giri.avif";
import sanchitImg from "/assets/Sanchit Gupta.avif";
...
export const directors = [
  {
    ...
    image: sandipImg,
    preview:
      "Mr. Sandip Kumar Deb is the Vice Chairman of the Tangible Assets Board of IVSC. He is the Registered Valuer Director of the Assessors and Registered Valuers Foundation of India...",
  ...
  },
  {
    ...
    title: "Director",
    image: praveenGuptaImg,
    preview:
      "With a distinguished career spanning over four decades, Praveen Kumar Gupta has been a stalwart in India's cooperative movement. As an advisory member to several National Cooperative Federations...",
  ...
  },
  {
    ...
    image: psImg,
    preview:
      "Praveen Subramanya is a valuation expert with over 21 years of experience across real estate, business, financial instruments, and plant & machinery in India and international markets...",
  ...
  },
  {
    ...
    image: sgImg,
    preview:
      "Saurabh Gupta is a seasoned management professional with nearly two decades of experience in consulting, business development, and strategic leadership. As Managing Director of AaRVF...",
  ...
  },
  {
    ...
    image: rahulImg,
    preview:
      "With over 14 years of experience, Rahul Sharma is a seasoned professional in commercial operations, stakeholder liaison, and strategic business development. He has successfully interfaced with Indian Railways...",
  ...
  },
  {
    ...
    image: hariomImg,
    preview:
      "Hariom Giri is a seasoned valuation professional with over 25 years of experience in real estate and infrastructure valuation. As a Property Valuer at GCA Technical Consultants...",
  ...
  },
  {
    ...
    image: sanchitImg,
    preview:
      "Sanchit Gupta is a real estate and construction professional with over 10 years of experience in sales, project coordination, and client relationship management across India's built environment sector...",
